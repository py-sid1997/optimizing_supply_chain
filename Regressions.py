...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 30 07:01:39 2021
...
# #weave time= 'Actual Weaver Issue Date'-'Actual Off Loom Date'
# weave_time = pd.DataFrame()
# weave_time['OTN No']= order_seven_years['OTN No']
# weave_time[['Actual Weaver Issue Date']]= pd.to_datetime(order_seven_years['Actual Weaver Issue Date'], format="%d/%m/%y %H:%M")
# weave_time['Actual Off Loom Date']= pd.to_datetime(order_seven_years['Actual Off Loom Date'], format="%d/%m/%y %H:%M")
# weave_time['difference']= weave_time['Actual Off Loom Date']-weave_time['Actual Weaver Issue Date']
...
# y=weave_time[(weave_time['days']<1000) &(weave_time['days']>0)].describe()
...
# df=df[df['days']<2000]
# plt.scatter(df['days'], df['Order Priority'])
# plt.xlabel("days")
...
# sns.boxplot(x=df['Month Name'],y=df['days'], color='green', 
#             showmeans=True,
#             meanprops={"marker":"o",
#                         "markerfacecolor":"white", 
#                         "markeredgecolor":"black",
#                       "markersize":"5"},
#             fliersize=5,order=x_i)
...
#,'Shape','Size','Design','Fiber Content','Primary Style
